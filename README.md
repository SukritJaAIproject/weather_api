...
- WorldWeatherOnline : https://github.com/ekapope/WorldWeatherOnline 
- https://pvlib-python.readthedocs.io/en/stable/reference/generated/pvlib.forecast.HRRR_ESRL.get_processed_data.html
```	